...
const CatalogItem: FC<ICatalogItem> = memo(({item, addToFavouritesHandler, favourites}): JSX.Element => {
      ...
      {inView && (
        <>
          ...
          <div className='item__mask'>          
            ...
            <button
              className={cn('item__favourite', {'item__favourite--active': ids.includes(id)})}
              type='button'
